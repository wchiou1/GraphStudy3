(function($P) {
	...
	$P.D3.EntityLink = $P.defineClass(
		$P.D3.Element,
		function D3EntityLink(config) {
			if (!(this instanceof D3EntityLink)) {return new D3EntityLink(config);}
	...
	$P.D3.EntityLink.appender = $P.D3.Element.appender.bind(undefined, $P.D3.EntityLink);
