(function($P) {
	...
	$P.D3.SunEntity = $P.defineClass(
		$P.D3.Element,
		function D3SunEntity(config) {
			if (!(this instanceof D3SunEntity)) {return new D3SunEntity(config);}
	...
	$P.D3.SunEntity.appender = $P.D3.Element.appender.bind(undefined, $P.D3.SunEntity);
